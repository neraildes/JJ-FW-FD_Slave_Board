...
# 243 "SlaveLiofilizadorVer1.c"
     while(1)
          {

         generic_status.flag_main_loop_WDT=1;
# 272 "SlaveLiofilizadorVer1.c"
         if(++canal==2) canal=0;
...
# 320 "SlaveLiofilizadorVer1.c"
    ...
    switch(usart_protocol.command){
        ...
        case 0X2B:
             Send_To_MB(11);
             USART_put_string("v1.0.3");
             break;
        case 0X1A:
# 360 "SlaveLiofilizadorVer1.c"
        ...
        case 0x02:
             ...
             segundo=0;
             break;
# 392 "SlaveLiofilizadorVer1.c"
        case 0x03:
             Send_To_MB(2);

             USART_put_int(1);
# 405 "SlaveLiofilizadorVer1.c"
             break;
